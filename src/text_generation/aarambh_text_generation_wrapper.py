...
from .text_generation import AarambhTextGenerationModel
from .text_generation_tokenizer import AarambhTokenizer

class AarambhTextGenerationWrapper:
    def __init__(self, vocab_size=50257, d_model=512, nhead=8, num_encoder_layers=6, num_decoder_layers=6, dim_feedforward=2048, max_seq_length=512):
        ...
        self.model = AarambhTextGenerationModel(vocab_size, d_model, nhead, num_encoder_layers, num_decoder_layers, dim_feedforward, max_seq_length)
